...
public:
    ...
    void setupUi(QWidget *ProgressWidget)
    {
        ...
        textEdit_id = new QTextEdit(frameBackground);
        ...
        pushButton_3 = new QPushButton(frameBackground);
...
"}"));
        ...
        pushButton_2 = new QPushButton(frameBackground);
...
"}"));
        ...
        refresh = new QPushButton(frameBackground);
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 718, 800));
...
""));
    ...
    void retranslateUi(QWidget *ProgressWidget)
    {
        ...
        label->setText(QApplication::translate("ProgressWidget", "\347\227\205\344\272\272ID\345\217\267\357\274\232", Q_NULLPTR));
